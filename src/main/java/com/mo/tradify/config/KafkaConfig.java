...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        config.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, StringSerializer.class); // change to String for now
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "tradify-group");
